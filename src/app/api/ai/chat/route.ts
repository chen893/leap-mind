...
export async function POST(req: Request) {
  try {
    ...
    const { courseId, chapterNumber,type, content, userAnswer ,messages } = await req.json();
    // 验证章节存在
    ...
    const chapter = course.chapters.find(chapter => chapter.chapterNumber === chapterNumber);
